...
interface ApiService {
    ...
    // ── Auth ──────────────────────────────────────────────────────────────
    @POST("v1/auth/login")
    suspend fun login(@Body request: LoginRequest): ApiEnvelope<LoginApiResponse>

    @POST("v1/auth/google")
    suspend fun loginWithGoogle(@Body request: GoogleLoginRequest): ApiEnvelope<LoginApiResponse>
    ...
    /** Own employee profile — no module.employees gate needed. */
    @GET("v1/me/profile")
