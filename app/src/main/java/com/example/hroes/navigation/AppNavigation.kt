package com.example.hroes.navigation
...
import com.example.hroes.ui.components.BottomNavBar
import com.example.hroes.ui.components.BottomNavItem
import com.example.hroes.ui.screens.*
        ...
        NavHost(
            ...
            composable(Screen.Profile.route) {
                ...
                ProfileScreen(
                    ...
                    onLogout = {
                        scope.launch {
                            com.example.hroes.data.repository.AuthRepository().logout()
                        }
                        // Navigate back to TenantSetup so the user can switch
                        // companies on logout, or directly to Login if domain is saved.
                        val hasDomain    = !com.example.hroes.data.api.TokenManager.tenantDomain.isNullOrBlank()
