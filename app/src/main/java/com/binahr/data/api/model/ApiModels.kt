package com.binahr.data.api.model
...
data class DashboardSummaryDto(
    ...
    @SerializedName("has_open_check_in")    val hasOpenCheckIn: Boolean,
    @SerializedName("attendance_today")     val attendanceToday: AttendanceTodayDto?,
    @SerializedName("monthly_stats")        val monthlyStats: MonthlyStatsDto?,
...
data class EmployeeDetailDto(
    ...
    val npwp: String?,
    @SerializedName("bpjs_kesehatan")          val bpjsKesehatan: String?,
    @SerializedName("bpjs_ketenagakerjaan")    val bpjsKetenagakerjaan: String?,
)
